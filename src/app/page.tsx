      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md mb-12">
            <h2 className="text-2xl font-semibold mb-4">About Herbowicz Lineage</h2>
            <div className="space-y-4 text-gray-700">
              ...
              <p>
                Unlike in England or France, where a shield usually belongs to a single family, a Polish Herb was a shared symbol of dozens, sometimes hundreds, of families bound by a common identity and code of honor. As the custodians of this shared shield, the Herbowicz were the original registrars of reputation. They ensured that every mark of honor was a verified testament to a group's standing and its adherence to the laws of the Commonwealth.
              </p>
              <p>
                Today, we translate this ancestral mission into the digital frontier. At <strong>Coat.digital</strong>, we create digital coats of arms certified by the Herbowicz lineage, helping you define your ethical 'Coat of Arms' in the digital world.
              </p>
            </div>
          </div>
